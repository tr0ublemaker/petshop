...
function getCateById($id){
	$sql="select id,cName from pet_cate where id={$id}";
	return fetchOne($sql);
}
 ...
 */
function getAllCate(){
	$sql="select id,cName from pet_cate";
	$rows=fetchAll($sql);
	return $rows;
}

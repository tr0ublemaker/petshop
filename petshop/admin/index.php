...
<body>
    <div class="head">
<!--     <h3 class="head_text logo">PET</h3> -->
            <h3 class="head_text fr">网上宠物店后台管理系统</h3>
    </div>
    <div class="operation_user clearfix">
        ...
        <div class="link fr">
            ...
            </b>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="icon icon_n">刷新</a><span></span><a href="doAdminAction.php?act=logout" class="icon icon_e">退出</a>
        </div>
    </div>
